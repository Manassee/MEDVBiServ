...
using MEDVBiServ.App.Application.Dtos;         // VerseDto, BookInfos (achte auf deinen Typnamen!)
using MEDVBiServ.App.Application.Interfaces;   // IBibleRepository
using MEDVBiServ.App.Domain.Entities;          // Bible (Entity)
